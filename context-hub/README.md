# ⚡ CodeForge 2040 v18.0 — Quantum Omnipresent AI Engine & Multi-Model Suite
...
![CodeForge Banner](https://img.shields.io/badge/CodeForge-v18.0_Quantum-6366f1?style=for-the-badge&logo=codeforces&logoColor=white)
![AI Models](https://img.shields.io/badge/AI_Models-Gemini_2.0_|_DeepSeek_R1_|_Claude_3.5_|_GPT--4o_|_Llama_3.3-22d3ee?style=for-the-badge)
![CDN Libraries](https://img.shields.io/badge/CDN_Libraries-18+_Engine_Plugins-34d399?style=for-the-badge)
![Status](https://img.shields.io/badge/Build-Passing-10b981?style=for-the-badge)
...
- **Export Options**:
  ...
  - 🐳 Docker Compose Container Stack (`Dockerfile` + `docker-compose.yml`)
  - 📱 PWA Manifest & Service Worker Bundle
...
| `Ctrl + F` / `Cmd + F` | Search & Replace in Code Theater |
| `Tab 1` | Jump to Forge Wizard |
| `Tab 2` | Open 50 Quantum Blueprints |
| `Tab 3` | View Build History & Snapshots |
| `T` | Cycle Deep Space Visual Themes |
| `Q` | Open Mobile QR Code Share |
| `L` | Open Prompt Archetype Lab |
| `M` | AI Model Performance Benchmark Matrix |
| `K` | Web Audio Synth Keyboard |

---

## ⚙️ Quick Setup & API Keys Guide

1. **Open Settings**: Click `⚙ API Keys` in the top right header.
2. **Enter Key**:
   - **OpenRouter**: Get key at [openrouter.ai/keys](https://openrouter.ai/keys)
   - **Groq**: Get key at [console.groq.com/keys](https://console.groq.com/keys)
   - **Anthropic**: Get key at [console.anthropic.com](https://console.anthropic.com)
   - **Ollama Local**: Run `ollama run qwen2.5-coder:32b` on your machine.
3. **Verify Key**: Click `🧪 Verify` to test key connectivity.
4. **Permanent Storage**: Verified keys are saved automatically to `localStorage` (`cf_keys`).
